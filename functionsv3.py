...
# На нажатие
def get_old_e1(start_dot, old_control_start, A)   #подсчет первоначального положения e1
    ...
    old_e1.y = k.y + (A.y - k.y)*t 

    return old_e1 

# На нажатие
def get_e2(end_dot, old_control_end, A):      #то же самое
